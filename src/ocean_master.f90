...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !call OutPut_MulRun_ObjFunction &
    !     (OutPut_Path,GrdInfo,OcnStat,TimTick,AllFrc_OcnStat,SrfFlux,CFM_Par,CFM_Stat)
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    write(*,*),'----------------------------------------------------------------------------'
    write(*,*),'CFM_Stat.Eq_T34              = ',CFM_Stat.Eq_T34
    write(*,*),'OcnStat.SSTA_N34             = ',OcnStat.SSTA_N34
    write(*,*),'OcnStat.TSUB_N4              = ',OcnStat.TSUB_N4
    write(*,*),'OcnStat.TSUB_N3              = ',OcnStat.TSUB_N3
    write(*,*),'----------------------------------------------------------------------------'
