...
SUBROUTINE CFModel_Write_MonMe_OutPut(OutPath,CFM_Par,CFM_Stat,TimTick,WriteIT);
    ...
    call NC_Write_One_IT(OutPath,CFM_OutName,'IntDec',CFM_Stat.MonMe_IntDec,WriteIT);
    call NC_Write_One_IT(OutPath,CFM_OutName,'ItrAmp',CFM_Stat.MonMe_ItrAmp,WriteIT);
...
SUBROUTINE CFModel_Get_MonMe_Stat(TimTick,CFM_Par,CFM_Stat)
    ...
    !$omp section
    call Update_MonMe_Var (CFM_Stat.IntDec,  CFM_Stat.MonMe_IntDec, &
         Arrive_CMonth_FLAG, Reach_CMonth_FLAG, Leap_Calendar_OnOff, CYear, CMonth, Day_NT)
    
    call Update_MonMe_Var (CFM_Stat.ItrAmp, CFM_Stat.MonMe_ItrAmp, &
         Arrive_CMonth_FLAG, Reach_CMonth_FLAG, Leap_Calendar_OnOff, CYear, CMonth, Day_NT)
